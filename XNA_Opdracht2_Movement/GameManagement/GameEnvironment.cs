...
public class GameEnvironment : Game {
    ...
    public void SetFullScreen(bool fullscreen = true) {
        var scalex = GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Width / (float)screen.X;
        var scaley = GraphicsAdapter.DefaultAdapter.CurrentDisplayMode.Height / (float)screen.Y;
        var finalscale = 1f;
